<template>
  ...
  >
    <!-- 1. 可拖拽 -->
    <template v-if="!readonly && mergeConfig.drag">
      <i class="ivu-icon-upload"></i>
      <div class="ivu-upload__text" v-html="$nclang('uploadTips')"></div>
    </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        // modelVal：请使用该值来绑定实际的组件的modivu--> [{name: 'xx', url: ''}]
      }
    },
