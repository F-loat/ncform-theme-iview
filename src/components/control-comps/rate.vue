    ...
    data() {
      return {
        ...
        defaultConfig: {
          ...
          iconClasses: ['ivu-icon-star-on', 'ivu-icon-star-on','ivu-icon-star-on'], // icon 的类名数组，共有 3 个元素，为 3 个分段所对应的类名
          voidIconClass: 'ivu-icon-star-off', // 未选中 icon 的类名
          disabledVoidIconClass: 'ivu-icon-star-on', // 只读时未选中 icon 的类名
